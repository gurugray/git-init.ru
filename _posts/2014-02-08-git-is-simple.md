...
Git ожидает довольно строгого формата от всех объектов, и только лишь блобы не структурированы.
...
Git преобразует индекс в серию связанных объектов в обектной базе. Блобы и деревья, содержимое которых совпадает — повторно используются, а для файлов и директорий, которые изменились — генерируются.
