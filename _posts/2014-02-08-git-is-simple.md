...
**Blob'ы** это куски данных, которые Git никаким образом не интерпретирует, это то как Git хранит ваши файлы.
...
Git ожидает, что операция переименования файлов достаточно частая и, если бы имена файлов были объединены с содержимым, вам бы пришлось хранить много копий объектов, разница между которыми была бы лишь в имени файла.
...
Они могут указывать на *любой* тип объектов, что означает, что вы технически можете создать что-то вроде этого (правда не ясно зачем вам может такое понадобиться):
