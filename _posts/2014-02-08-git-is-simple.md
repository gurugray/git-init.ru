...
Git ожидает, что операция переименования файлов достаточно частая и, если бы имена файлов были объеденены с содержимым, вам бы пришлось хранить много копий объектов, разница между которыми была бы лишь в имени файла.
...
Они могут указывать на *любой* тип объектов, что означает, что вы технически может создать что-то вроде этого (правда не ясно зачем вам может такое понадобиться):
